...
?><h2><?php echo GxHtml::encode($model->getRelationLabel('productos')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->productos as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('producto/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
		echo GxHtml::closeTag('li');
	}
	echo GxHtml::closeTag('ul');
?>