	...
	<div id="mainmenu">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'About', 'url'=>array('/site/page', 'view'=>'about'),'visible'=>Yii::app()->user->isGuest+Util::isEmpresa(Yii::app()->user->name)),
				array('label'=>'Contact', 'url'=>array('/site/contact'),'visible'=>Yii::app()->user->isGuest),
				
                                array('label'=>'Camiones','url'=>array('/camion/admin'),'visible'=>(Util::isAdmin(Yii::app()->user->name))+Util::isOperador(Yii::app()->user->name)),
				...
				array('label'=>'Logout ('.Util::getTipoUsuario(Yii::app()->user->name).': '.Yii::app()->user->name.')', 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest),
                                array('label'=>'Registrarse', 'url'=>array('/empresa/create'), 'visible'=>Yii::app()->user->isGuest),
                            ),
		)); ?>
