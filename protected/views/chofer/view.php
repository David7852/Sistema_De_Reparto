...
<h2><?php echo GxHtml::encode($model->getRelationLabel('camions')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->camions as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('camion/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
