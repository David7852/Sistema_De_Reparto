...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<div class="row">               
                ...
                <?php       
                $codencargo = substr(Yii::app()->request->url,strpos(Yii::app()->request->url,"&id=")+4,strlen(Yii::app()->request->url));
                $codencargo=1+(int)$codencargo;
                $this->widget('zii.widgets.grid.CGridView', array(
                'id' => 'paquete-grid',
                'dataProvider' => $PA->searchb($codencargo),
                //'filter' => $PA,
                'columns' => array(
		'cod_paquete',
		'peso',
		...
		array(
				...
				'filter'=>GxHtml::listDataEx(Presupuesto::model()->findAllAttributes('cod_presupuesto', true)),
				),
		'alto',
		'ancho',
		/*
		...
		array(
                    'class' => 'CButtonColumn',
                    'deleteConfirmation'=>'Va a vincular o desvincular este paquete',
                    'template' => '{delete}',
                    ...
                    'deleteButtonUrl' =>'Yii::app()->createUrl("/paquete/delete",array("id" => $data["cod_paquete"],"Y"=>'.$codencargo.'))',
                    'deleteButtonImageUrl'=>Yii::app()->request->baseUrl.'/images/ADD.png', 
                    //'updateButtonUrl'=>'Yii::app()createUrl("download",array("userID"=>$data->userID,"filename"=>$data->filename))',
//        'buttons'=>array(
//            
//            'remo' => array
//            (
...
//            'url'=>'Yii::app()->createUrl("/paquete/delete",array("id" => $data["cod_paquete"],"Y"=>'.$codencargo.',"W"=>0))',
...
//                    'class' => 'CButtonColumn',
//                    
//                    //'updateConfirmation'=>'Seguro que quiere DESvincular este paquete con este envio?',
//                    
//                    
//                    'template' => '{delete}',
//                    'updateButtonLabel'=>'Remover',
//                    //'updateButtonUrl' =>'Yii::app()->createUrl("/customer/editmember1",array("id" => $data->primaryKey))',
//                    //'updateButtonImageUrl'=>Yii::app()->request->baseUrl.'/images/edit.jpg',
//                    'updateButtonUrl' =>'Yii::app()->createUrl("/paquete/delete",array("id" => $data["cod_paquete"],"Y"=>'.$codencargo.',"W"=>false))',
//                    'updateButtonImageUrl'=>Yii::app()->request->baseUrl.'/images/REMOVE.png',                     
//		),
